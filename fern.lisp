...
;;;;; -*- mode: common-lisp;   common-lisp-style: modern;    coding: utf-8; -*-
;;;;;
;;;;; FERN TRIES: efficient key-value tuple storage

;; Replicated from public github repo https://github.com/danlentz/fern

(defpackage #:fern
  (:nicknames #:f)
  (:use    #:common-lisp)
  (:shadow #:copy #:delete #:map #:count #:get #:put #:dismantle)
  (:export #:<> #:root #:make #:copy #:delete #:get #:put #:get-node #:get-node* #:map #:map-nodes
           #:dismantle #:map-keys #:map-values #:keys #:vals #:filter #:count #:fern-name
           #:fern-id #:fern-plist #:fern-trie

           #:get-trie #:trie-keys #:trie-values #:maptrie #:make-trie

           #:*list-to-hashtable-threshold* #:*initial-hash-table-size*
           #:*rehash-size*))
